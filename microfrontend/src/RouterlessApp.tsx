    ...
    <QueryProvider>
      <div>
        <nav style={{
          ...
          <h3 style={{ margin: "0 0 15px 0", color: "#1a202c" }}>🚀 Microfrontend API Demo</h3>
          <div style={{
            display: "flex",
            flexWrap: "wrap",
            gap: "8px"
            ...
            {navLinks.map(({ path, label }) => (
              <Link
                ...
                style={{
                  ...
                  padding: "8px 16px",
                  borderRadius: "6px",
                  backgroundColor: location.pathname === `${basePath}${path}` ? "#3b82f6" : "#e2e8f0",
                  color: location.pathname === `${basePath}${path}` ? "white" : "#374151",
                  fontSize: "0.875rem",
                  fontWeight: "500",
                  transition: "all 0.2s",
                  border: "none"
