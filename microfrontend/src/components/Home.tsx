  ...
  const features = [
    {
      ...
      description:
        "Create, manage, and track task completion with full CRUD operations",
      path: "/tasks",
      color: "#3B82F6",
    },
    {
      ...
      description:
        "Browse products with detailed views and create new product entries",
      path: "/products",
      color: "#10B981",
    },
    {
    ...
    },
    {
      ...
      description:
        "Organize content with hierarchical categories and visual indicators",
      path: "/categories",
      color: "#EC4899",
    },
    {
      ...
      description:
        "Comprehensive overview of all data with charts and insights",
      path: "/analytics",
      color: "#06B6D4",
    },
    {
  ...
  return (
    <main>
      <div id="app">
        ...
        <p>
          This application demonstrates TypeScript + React + TanStack Query
          integration with 8 different API endpoints.
        </p>
