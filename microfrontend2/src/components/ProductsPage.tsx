...
const ProductsPage: React.FC = () => {
  ...
  const { data: selectedProduct, isLoading: loadingProduct } = useQuery({
    ...
    queryFn: () =>
      apiClient.productsService.productsDetail({ id: selectedProductId! }),
  ...
  const createProductMutation = useMutation({
    mutationFn: (newProduct: ProductInput) =>
      apiClient.productsService.productsCreate(newProduct),
    onSuccess: () => {
            ...
            loadingProduct ? (
              ...
              >
                ...
                <div style={{ marginBottom: "10px" }}>
                  <strong>Price: </strong>
                  <span style={{ fontSize: "1.5em", color: "#3B82F6" }}>
                ...
                <div style={{ marginBottom: "10px" }}>
                  ...
                  <span
                    style={{
                      backgroundColor: selectedProduct.data.inStock
                        ? "#10B981"
                        : "#EF4444",
                      color: "white",
                      padding: "4px 8px",
